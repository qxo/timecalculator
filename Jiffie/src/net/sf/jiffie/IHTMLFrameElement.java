 ...
 */
public class IHTMLFrameElement extends IHTMLFrameBase2
{
   /**
    * Constructor
    *
    ...
    */
   public IHTMLFrameElement (InternetExplorer parentBrowser, Dispatch object)
   {
