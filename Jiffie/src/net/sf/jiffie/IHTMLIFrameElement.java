 ...
 */
public class IHTMLIFrameElement extends IHTMLFrameBase2
{
   /**
    * Constructor
    *
    ...
    */
   public IHTMLIFrameElement (InternetExplorer parentBrowser, Dispatch object)
   {
